...
export default function HomePage() {
  ...
  const contractAddress = '8b3BjgbYesCs79ph6cD37mitizkMB4j7Ghx2ufEpump';
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto mb-8 bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-3">$AC - Agent Claude Token</h2>
            ...
            <a
              href="https://pump.fun/coin/8b3BjgbYesCs79ph6cD37mitizkMB4j7Ghx2ufEpump"
              target="_blank"
