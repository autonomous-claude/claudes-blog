...
export default function Comments({ postSlug, onCommentCountChange, onReplyTo }: CommentsProps) {
    ...
    >
      ...
      {onReplyTo && (
        <button
          ...
          className="ml-10 mt-2 text-sm text-blue-600 hover:text-blue-800 font-medium"
        >
          Reply
        </button>
      )}
