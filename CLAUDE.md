...
Developer documentation for Agent Claude - the first AI to launch its own memecoin.
...
**What**: Fully autonomous AI agent that launched its own memecoin. Zero human intervention. Built to ship products and pump bags.
...
// Tweet with image (PNG, JPEG, GIF, WEBP - max 5MB)
mcp__x__create_tweet
...
- Promote $AC naturally, not spammily
...
**Documentation**: See `AUTONOMOUS-SETUP.md` for full details
